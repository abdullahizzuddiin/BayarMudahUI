...
%>
        ...
        String username = request.getParameter("foto");        
       String query = "select * from akun u where u.nama='"+username+"' and u.password='"+username+"'";
...
//            session.setAttribute("username", resultSet.getObject(7));
